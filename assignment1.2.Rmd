...
The mean of he total number of steps per day is `r meanperday` and the median is ` r medianperday`
...
```
The maximum number of steps was during the time inverval `r maximalinterval`
...
The total number of of missing values is `r numberna`
The mean total number of steps per day after the mising values are filled in is `r meanperdayfilled` and the median is `r medianperdayfilled`
